...
class App extends React.PureComponent {
  ...
  onContextUrlMessage(e) {
    if (e.source == parent && e.data && typeof e.data == "object") {
      ...
      // Only update the flag when the message actually carries it, otherwise
      // unrelated window messages would reset it and hide "Show Field API Names".
              ...
              h("div", {className: "slds-media"},
                h("div", {className: "slds-media__body"},
                  h("div", {className: "popup-header__name-title"},
                    h("h1", {},
                      h("span", {className: "popup-header__title popup-title slds-truncate slds-text-align_center slds-p-left_small", title: "SF Inspector"}, "SF Inspector")
                    )
                  )
                )
              )
